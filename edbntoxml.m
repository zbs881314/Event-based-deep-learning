...
% Load defaults
if ~isfield(opts,'makevisdim'), opts.makevisdim =1; 
end
if ~isfield(edbn,'fw_conns'), edbn.fw_conns=num2cell([2:numel(edbn.sizes) 0]); 
end
if ~isfield(edbn,'fw_erbm'),  edbn.fw_erbm=[1:numel(edbn.erbm) 0]; 
end
